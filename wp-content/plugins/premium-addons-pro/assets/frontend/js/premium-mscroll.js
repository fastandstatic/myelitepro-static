(function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        var premiumMScrollHandler = function ($scope, $) {
            ...
            $("#sticky-hide").addClass("pa-invisible");
                    ...
                    function () {
                        ...
                        mScrollElems.each(function (index, elem) {
                            ...
                            if ('automatic' === settings.trigger) {
                                ...
                                // var shouldGenerateAnimation = !isEditor || (isEditor && mScrollElems.index($scope) == index);
                                ...
                                if ('sticky' === settings.trigger && isEditor)
                                    settings.trigger = 'play';
                                ...
                                if ('sticky' === settings.trigger) {
                                    ...
                                    //If the target select contains ID, then we will select it without adding parents.
                                            ...
                                            onToggle: function (line) {
                                                ...
                                                if ('sticky' === timeLineSettings.trigger) {
                                                    ...
                                                    if (line.progress < 0.5) {
                                                        ...
                                                        if ("sticky-hide" === $(stickyElem).attr("id"))
                            ...
                            if ('sticky' !== settings.trigger || !$(stickyElem).hasClass("sticky-hide"))
            ...
            function handleSticky(stickyElem, settings) {
                ...
                var offsetDiff = $stickyElem.offset().top - $(settings.stickyRef).offset().top,
                    stickyHide = 'sticky-hide' === $(stickyElem).attr("id");
